...
Тест на профориентацию: тип личности, топ-5 подходящих профессий, нумерология карьеры и пошаговый план смены профессии. Тип личности — бесплатно.
...
- Return URL: `https://career-type-test.vercel.app/thank-you`
- Webhook URL: `https://career-type-test.vercel.app/api/webhook` — события `payment.succeeded` и `payment.canceled`
